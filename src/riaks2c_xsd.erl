...
{model,[{type,'_document',sequence,
              [{el,[{alt,'AccessControlPolicy','AccessControlPolicy',[],1,1,
                         true,undefined},
                    {alt,'ListBucketResult','ListBucketResult',[],1,1,true,
                         undefined},
                    {alt,'ListAllMyBucketsResult','ListAllMyBucketsResult',[],
                         1,1,true,undefined},
                    {alt,'InitiateMultipartUploadResult',
                         'InitiateMultipartUploadResult',[],1,1,true,
                         undefined},
                    {alt,'CompleteMultipartUploadResult',
                         'CompleteMultipartUploadResult',[],1,1,true,
                         undefined},
                    {alt,'CompleteMultipartUpload','CompleteMultipartUpload',
                         [],1,1,true,undefined},
                    {alt,'ListMultipartUploadsResult',
                         'ListMultipartUploadsResult',[],1,1,true,undefined},
        ...
        {type,'Error',sequence,
              [{el,[{alt,'Code',{'#PCDATA',char},[],1,1,true,undefined}],
               ...
               {el,[{alt,'#any',any,[],1,1,true,
                    ...
                    {alt,'ListBucketResult','ListBucketResult',[],1,1,true,
                         undefined},
                    {alt,'AccessControlPolicy','AccessControlPolicy',[],1,1,
                         true,undefined}],
                   0,unbound,undefined,7}],
              [],undefined,undefined,6,1,1,undefined,undefined},
        {type,'MultipartUpload',sequence,
              [{el,[{alt,'Key',{'#PCDATA',char},[],1,1,true,undefined}],
                   1,1,undefined,3},
               {el,[{alt,'UploadId',{'#PCDATA',char},[],1,1,true,undefined}],
                   1,1,undefined,4},
               {el,[{alt,'Initiator','CanonicalUser',[],1,1,true,undefined}],
                   1,1,undefined,5},
        ...
        {type,'ListMultipartUploadsResult',sequence,
              [{el,[{alt,'Bucket',{'#PCDATA',char},[],1,1,true,undefined}],
               ...
               {el,[{alt,'IsTruncated',
                         ...
                         [],1,1,true,undefined}],
                   1,1,undefined,11},
               {el,[{alt,'Upload','MultipartUpload',[],1,1,true,undefined}],
        ...
        {type,'MultipartUploadPart',sequence,
              [{el,[{alt,'PartNumber',
                         {'#PCDATA',integer},
                         [],1,1,true,undefined}],
                   1,1,undefined,3},
        ...
        {type,'CompleteMultipartUpload',sequence,
              [{el,[{alt,'Part','MultipartUploadPart',[],1,1,true,undefined}],
                   1,unbound,undefined,3}],
              [],undefined,undefined,2,1,1,undefined,undefined},
        {type,'CompleteMultipartUploadResult',sequence,
        ...
        {type,'InitiateMultipartUploadResult',sequence,
              [{el,[{alt,'Bucket',{'#PCDATA',char},[],1,1,true,undefined}],
                   1,1,undefined,3},
               {el,[{alt,'Key',{'#PCDATA',char},[],1,1,true,undefined}],
                   1,1,undefined,4},
